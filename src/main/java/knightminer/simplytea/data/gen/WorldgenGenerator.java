...
public class WorldgenGenerator extends DatapackBuiltinEntriesProvider {
    public static final RegistrySetBuilder BUILDER = new RegistrySetBuilder()
            .add(Registries.CONFIGURED_FEATURE, Registration::configuredFeatures)
            .add(Registries.PLACED_FEATURE, Registration::placedFeatures)
            .add(ForgeRegistries.Keys.BIOME_MODIFIERS, Registration::biomeModifiers);
